...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-gulden-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-gulden-node add wallet-service');
      console.log('    $ bitcore-gulden-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-gulden-node remove wallet-service');
      console.log('    $ bitcore-gulden-node remove insight-api');
      console.log();
    });
