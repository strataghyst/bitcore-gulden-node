...
/**
 * Will return the path and default bitcore-gulden-node configuration. It will search for the
...
function getDefaultConfig(options) {
  ...
  var defaultConfigFile = path.resolve(defaultPath, './bitcore-gulden-node.json');
